...
router.post('/', (req, res) => {
  try {
    ...
    db.prepare(`
      INSERT INTO preferences (id, breakfasts_per_week, lunches_per_week, dinners_per_week, people_per_meal, dietary_restrictions, meal_complexity_levels, protein_per_serving, carbs_per_serving, fat_per_serving, recipe_units, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'))
